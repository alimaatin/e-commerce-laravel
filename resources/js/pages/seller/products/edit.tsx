...
import { BreadcrumbItem, Product, ProductForm, SharedData, Vendor } from "@/types";
...
export default function SellerProductCreate() {
    const { vendor, product } = usePage<SharedData & { vendor: Vendor, product: Product }>().props;
    ...
    const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
        e.preventDefault();
        post(route('seller.products.update', {vendor: vendor.id, product: product.id}), { forceFormData: true });
    }
